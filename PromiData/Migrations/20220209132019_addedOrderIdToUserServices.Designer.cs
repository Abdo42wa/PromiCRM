...
namespace PromiData.Migrations
{
    ...
    [Migration("20220209132019_addedOrderIdToUserServices")]
    partial class addedOrderIdToUserServices
    {
            ...
            modelBuilder.Entity("PromiData.Models.MaterialWarehouse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastAdittion = new DateTime(2022, 2, 9, 15, 20, 18, 682, DateTimeKind.Local).AddTicks(2554),
                            MeasuringUnit = "cm",
                            Quantity = 22500,
                            Title = "Fanera 3mm",
                            UseDays = 40
            ...
            modelBuilder.Entity("PromiData.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Adminas",
                            Password = "$2a$11$4jicWKEuM/e9Zw4nhvjDDOLC8Wk2/tGT/GXoEY4gw1UiPhX.QENQu",
                            PhoneNumber = "860855183",
                            Surname = "Admin",
                            TypeId = 1
                        });
            ...
            modelBuilder.Entity("PromiData.Models.WeeklyWorkSchedule", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2022, 2, 9, 15, 20, 18, 677, DateTimeKind.Local).AddTicks(781),
