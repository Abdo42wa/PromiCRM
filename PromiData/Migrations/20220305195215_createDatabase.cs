    ...
    public partial class createDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 5, null, null, "viena plokste 1,5x1,5m =22500", new DateTime(2022, 3, 5, 21, 52, 15, 335, DateTimeKind.Local).AddTicks(7818), "cm", 22500, "Fanera 3mm", 40 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("c9490c27-1b89-4e39-8f2e-99b48dcc709e"), "promiadmin@gmail.com", "Adminas", "$2a$11$lawO1CnAlk/fIEanNzkaW.dORw3rE3u8XyGyahI3MHxjy6OGXurTG", "860855183", "Admin", 1, null });

            migrationBuilder.InsertData(
                table: "WeeklyWorkSchedules",
                columns: new[] { "Id", "Date", "Description", "Done", "UserId" },
                values: new object[] { 1, new DateTime(2022, 3, 5, 21, 52, 15, 331, DateTimeKind.Local).AddTicks(1608), "Supildyti frezavimo laiko lentele", false, new Guid("c9490c27-1b89-4e39-8f2e-99b48dcc709e") });
