...
namespace PromiCRM.Migrations
{
    ...
    [Migration("20220205120340_updatedProductAndOrderModels")]
    partial class updatedProductAndOrderModels
    {
            ...
            modelBuilder.Entity("PromiCRM.Models.MaterialWarehouse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastAdittion = new DateTime(2022, 2, 5, 14, 3, 39, 322, DateTimeKind.Local).AddTicks(7929),
                            MeasuringUnit = "cm",
                            Quantity = 22500,
                            Title = "Fanera 3mm",
                            UseDays = 40
            ...
            modelBuilder.Entity("PromiCRM.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Adminas",
                            Password = "$2a$11$Ws8Bfccvq3.8hxd.xcgye.iJ9r/XJRapaRIj6RHCidC03poDb1kpK",
                            PhoneNumber = "860855183",
                            Surname = "Admin",
                            TypeId = 1
                        });
            ...
            modelBuilder.Entity("PromiCRM.Models.WeeklyWorkSchedule", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2022, 2, 5, 14, 3, 39, 319, DateTimeKind.Local).AddTicks(3763),
