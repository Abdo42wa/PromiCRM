...
namespace PromiCRM.Migrations
{
    ...
    [Migration("20220204155713_addedUserToOrderService")]
    partial class addedUserToOrderService
    {
            ...
            modelBuilder.Entity("PromiCRM.Models.MaterialWarehouse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastAdittion = new DateTime(2022, 2, 4, 17, 57, 11, 732, DateTimeKind.Local).AddTicks(476),
                            MeasuringUnit = "cm",
                            Quantity = 22500,
                            Title = "Fanera 3mm",
                            UseDays = 40
            ...
            modelBuilder.Entity("PromiCRM.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Adminas",
                            Password = "$2a$11$sdMnl4jaNDMDTPSeWPzqcOmGJrLAICyFa9X0lzlcw15o4sMFPwrg.",
                            PhoneNumber = "860855183",
                            Surname = "Admin",
                            TypeId = 1
                        });
            ...
            modelBuilder.Entity("PromiCRM.Models.WeeklyWorkSchedule", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2022, 2, 4, 17, 57, 11, 727, DateTimeKind.Local).AddTicks(3817),
