...
namespace PromiCRM.Controllers
{
    ...
    public class ShipmentController : ControllerBase
    {
        ...
        public ShipmentController(IUnitOfWork unitOfWork, IMapper mapper, ILogger<ShipmentController> logger)
        {
        ...
        public async Task<IActionResult> GetShipments()
        {
            ...
            var results = _mapper.Map<IList<ShipmentController>>(shipment);
            return Ok(results);
        }
